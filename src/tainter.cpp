...
int main3(int argc, char** argv){
    ...
    {
        struct GlobalVariableInfo *gv_info = *i;
		vector<struct InstInfo *> hali = gv_info->getDirectDataFlow();
		llvm::outs() <<"getDirectDataFlow size= "<<hali.size()<<"\n";
		vector<struct InstInfo *> hali2 = gv_info->getIndirectDataFlow();
		llvm::outs() <<"getIndirectDataFlow size= "<<hali2.size()<<"\n";
    }
	return 0;
}
